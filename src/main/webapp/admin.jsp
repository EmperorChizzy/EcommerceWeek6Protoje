...
<% PrintWriter out1 = response.getWriter();
    ...
    out1.println("<style>");
    out1.println("    body {");
    out1.println("        background-image: url('src/main/webapp/images/slide-01.jpg');");
    out1.println("        background-size: cover;");
    out1.println("        background-position: center;");
    out1.println("        background-repeat: no-repeat;");
    out1.println("    }");
    out1.println("</style>");
    ...
    out1.println("  <span class=\"bold-text\">Emperor Chizzy</span> <span class=\"normal-text\">Wines & Liquor</span>");
    out1.println("</a>");
